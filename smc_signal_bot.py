...
SYMBOLS = ["BTCUSDT", "ETHUSDT", "BNBUSDT", "XRPUSDT", "SOLUSDT", "ADAUSDT", "DOGEUSDT", "TRXUSDT", "AVAXUSDT", "SHIBUSDT", "DOTUSDT", "LINKUSDT", "MATICUSDT", "LTCUSDT", "UNIUSDT", "ATOMUSDT", "XLMUSDT", "ETCUSDT", "FILUSDT", "APTUSDT", "NEARUSDT", "OPUSDT", "ARBUSDT", "INJUSDT", "SUIUSDT", "TIAUSDT", "SEIUSDT", "STXUSDT", "RUNEUSDT", "FETUSDT", "AGIXUSDT", "WLDUSDT", "PENDLEUSDT", "JUPUSDT", "DYMUSDT", "PYTHUSDT", "JTOUSDT", "ALTUSDT", "PIXELUSDT", "PORTALUSDT", "AAVEUSDT", "MKRUSDT", "SNXUSDT", "COMPUSDT", "CRVUSDT", "LRCUSDT", "GMXUSDT", "DYDXUSDT", "PERPUSDT", "APEUSDT"]
HTF = "1h"
ITF = "15m"
LTF = "5m"
MIN_SCORE = 20
